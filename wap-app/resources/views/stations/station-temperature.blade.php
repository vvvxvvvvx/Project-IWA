{{-- Overzicht van stations met temperatuurcorrecties. --}}
@extends('layouts.iwa')
...
<article class="panel">
    <div class="panel-header">
        <div>
            <h2>Stations met temperatuurcorrecties</h2>
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="status-badge warning">{{ $station->correction_count ?? 0 }} correcties</span></td>
                </tr>
                @empty
                <tr>
                    <td colspan="6" class="muted" style="text-align:center;">Geen stations met temperatuurcorrecties gevonden.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
