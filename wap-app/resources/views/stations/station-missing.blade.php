{{-- Overzicht van stations met ontbrekende meetdata. --}}
@extends('layouts.iwa')
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="status-badge warning">{{ $station->missing_count ?? 0 }} metingen</span></td>
                </tr>
                @empty
                <tr>
                    <td colspan="6" class="muted" style="text-align:center;">Geen stations met ontbrekende data gevonden.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
