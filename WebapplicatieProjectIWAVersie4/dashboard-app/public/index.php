...
$httpRouter->get('/stations', static fn () => (new StationOverviewPageController())->index(), $authenticatedRoutes);
...
$httpRouter->get('/subscriptions', static fn () => (new SubscriptionOverviewPageController())->index(), $employeeRoutes);
...
$httpRouter->get('/subscription-types', static fn () => (new SubscriptionTypeOverviewPageController())->index(), $employeeRoutes);
...
$httpRouter->get('/companies', static fn () => (new CompanyOverviewPageController())->index(), $employeeRoutes);
